...
import { SideNavigation } from '../components/SideNavigation';
import { ShieldCheckIcon, ActivityIcon, BellIcon, BotIcon, SendIcon, PhoneIcon, MailIcon, MapPinIcon } from 'lucide-react';
...
export function HomePage({ currentPage, onNavigate }: DashboardProps) {
