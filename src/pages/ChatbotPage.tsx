                                    ...
                                    {messages.map((message) => (
                                        ...
                                        >
                                            ...
                                            <div className={`flex flex-col max-w-[80%] ${message.sender === 'user' ? 'items-end' : 'items-start'}`}>
                                                <div className={`px-4 py-2.5 rounded-2xl text-sm leading-relaxed shadow-lg ${message.sender === 'user' ? 'bg-indigo-600 text-white rounded-tr-none shadow-indigo-500/30' : 'bg-slate-800/80 backdrop-blur-sm text-slate-200 border border-indigo-500/20 rounded-tl-none'} whitespace-pre-wrap break-words`}>
                                                    {message.text}
                                                </div>
